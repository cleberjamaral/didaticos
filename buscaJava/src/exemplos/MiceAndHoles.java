...
public class MiceAndHoles implements Estado, Heuristica, Aleatorio {
	...
	MiceAndHoles(MiceAndHoles modelo) {
		...
		for (int i = 0; i < modelo.holeCapacity.size(); i++){
			//origCapacity.add(modelo.origCapacity.get(i));
